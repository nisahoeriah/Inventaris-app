...
Route::get('/',[DashboardController::class,'petugas'])->name('admin.dashboard');
...
Route::get('peminjaman/pegawai/{pegawai}/add/{inventari}',[PeminjamanAdminController::class,'add'])
->name('admin.peminjaman.add');

Route::get('peminjaman/pegawai/{pegawai}/update/{inventari}',[PeminjamanAdminController::class,'update'])
->name('admin.peminjaman.update');

Route::get('peminjaman/pegawai/{pegawai}/delete/{inventari}',[PeminjamanAdminController::class,'delete'])
