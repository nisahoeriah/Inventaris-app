...
Route::middleware('auth')->group(function(){
    ...
    Route::get('peminjaman/add/{inventari}',[PeminjamanController::class,'add'])
    ->name('peminjaman.add');

    Route::get('peminjaman/update/{inventari}',[PeminjamanController::class,'update'])
    ->name('peminjaman.update');


    Route::get('peminjaman/delete/{inventari}',[PeminjamanController::class,'delete'])
