...
<x-content :title="[
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <form class="card card-primary" method="POST" action="{{ route('petugas.update',['petuga'=>$petugas->id]) }}">
                ...
                <div class="card-body">
                    @csrf
                    @method('put')
                    <x-input label="Nama Petugas" name="nama_petugas" :value="$petugas->nama_petugas" />

                    <x-input label="Username" name="username" :value="$petugas->username" />

                    <x-select label="Level" name="level" 
                    :value="$petugas->level" 
                    :data-option="[
