        ...
        <div class="card-body p-0">
            <table class="table table-hover table-striped m-0">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $no++ }}</td>
                        <td>{{ $pegawai->nama_pegawai }} <br> <small>NIP : {{ $pegawai->nip }}</small></td>
                        <td>{{ $pegawai->username }}</td>
                        <td>{{ $pegawai->alamat }}</td>
                        <td class="text-right">
                            <x-edit href="{{ route('pegawai.edit',['pegawai'=>$pegawai->id]) }}" />

                            <x-delete data-url="{{ route('pegawai.destroy',['pegawai'=>$pegawai->id]) }}" />
                        </td>
                    </tr>
                    @endforeach
                </tbody>
